...
namespace Filesystem
{
    ...
    static bool InitializeWorkspace()
    {
        ...
        if (SUCCEEDED(SHGetFolderPathA(NULL, CSIDL_APPDATA, NULL, 0, appdata)))
        {
            ...
            lstrcatA(g_workspace, "\\NotZayduck\\");
        ...
        lstrcpyA(g_workspace, "C:\\NotZayduck\\workspace\\");
        CreateDirectoryA("C:\\NotZayduck", NULL);
        CreateDirectoryA(g_workspace, NULL);
    ...
    inline int getcustomasset(lua_State* L) {
        ...
        try {
            ...
            auto customAssetsDir = std::filesystem::current_path() / "ExtraContent" / "NotZayduck";
            ...
            std::string Final = "rbxasset://NotZayduck/" + customAssetsFile.filename().string();
